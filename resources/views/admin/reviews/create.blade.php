...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Administration / <a href="{{ route('admin.reviews.index') }}">Avis</a> /</span> Ajouter un avis
    </h4>

    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Formulaire de création d'un avis</h5>
        </div>
        <div class="card-body">
            @if ($errors->any())
                ...
                <div class="mb-3">
                    ...
                    <div class="rating-container">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="rating" id="rating1" value="1" {{ old('rating') == '1' ? 'checked' : '' }} required>
