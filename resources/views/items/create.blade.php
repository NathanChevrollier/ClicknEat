                ...
                <div class="card-body">
                    <form action="{{ route('items.store') }}" method="POST" class="mb-3">
                        ...
                        @if(request()->has('restaurant_id'))
                            <input type="hidden" id="selected_restaurant_id" value="{{ request('restaurant_id') }}">
                        @endif
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ request()->has('restaurant_id') ? route('restaurants.show', request('restaurant_id')) : route('restaurants.index') }}" class="btn btn-outline-secondary">
