...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Restaurants / {{ $restaurant->name }} /</span> Ajouter un avis
    </h4>

    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                <h5 class="card-header">Votre avis sur {{ $restaurant->name }}</h5>
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <form action="{{ route('restaurants.reviews.store', $restaurant->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('comment') is-invalid @enderror" id="comment" name="comment" rows="5" placeholder="Partagez votre expérience avec ce restaurant...">{{ old('comment') }}</textarea>
                            @error('comment')
                        ...
                        <div class="mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-check me-1"></i> Publier mon avis
                            </button>
                        </div>
                    </form>
                </div>
